<template>
  <!-- component -->
  <nav
      class="flex fixed bg-gradient-to-r from-blue-500 via-green-500 to-red-300 w-full items-center justify-between px-6 h-16 bg-white text-gray-700 border-b border-gray-200 z-50"
    >
      <div class="flex items-center">
        ...
        <a class="text-2xl">BPS Provinsi Kalimantan Tengah</a>
      </div>
      <!-- <div class="flex items-center">
  ...
  <section>
  <div class="bg-gradient-to-r from-blue-500 via-green-500 to-red-300 dark:bg-gray-800 relative min-h-screen pt-20">
